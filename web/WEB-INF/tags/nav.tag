...
<div class="header navbar navbar-inverse ">
    ...
    <div class="navbar-inner">
        <div class="header-seperation">
            ...
            <!-- BEGIN LOGO -->
            <a href="index.html"><img src="../../assets/img/logo.png" class="logo" alt=""
                                      data-src="../../assets/img/logo.png" data-src-retina="../../assets/img/logo2x.png"
    ...
    <div class="page-sidebar" id="main-menu">
        ...
        <div class="user-info-wrapper">
            ...
            <div class="user-info">
                ...
                <div class="username"><%= user.getUserName()%> <span class="semi-bold">Smith</span></div>
        ...
        <ul>
            ...
            <li class=""><a href="javascript:;"> <i class="icon-custom-ui"></i> <span class="title">UI Elements</span>
            ...
            <li class=""><a href="javascript:;"> <i class="icon-custom-portlets"></i> <span class="title">Grids</span>
                <span class="arrow "></span> </a>
                <ul class="sub-menu">
            ...
            <li class=""><a href="javascript:;"> <i class="icon-custom-thumb"></i> <span class="title">Tables</span>
                <span class="arrow "></span> </a>
                <ul class="sub-menu">
            ...
            <li class=""><a href="javascript:;"> <i class="icon-custom-extra"></i> <span class="title">Extra</span>
                <span class="arrow "></span> </a>
                <ul class="sub-menu">
            ...
            <li class=""><a href="javascript:;"> <i class="fa fa-folder-open"></i> <span
                    class="title">Menu Levels</span> <span class="arrow "></span> </a>
                <ul class="sub-menu">
