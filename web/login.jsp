...
<div class="container">
    <div class="row login-container column-seperation">
        <div class="col-md-5 col-md-offset-1">
            <h2>Sign in to Aquarius</h2>
            <p>Use Facebook, Twitter or your email to sign in.<br>
                <a href="#">Sign up Now!</a> for a Aquarius account,It's free and always will be..</p>
            <br>
        ...
        <div class="col-md-5 "> <br>
            <form id="<%=Constants.LOGIN_FORM_ID%>" method="post" action="<%=Constants.LOGIN_FORM_ACTION%>" class="login-form">
                <div class="row">
                    <div class="form-group col-md-10">
                        ...
                        <div class="controls">
                            <div class="input-with-icon  right">
                                <i class=""></i>
                                <input type="text" name="<%=Constants.LOGIN_USERNAME_FIELD%>" id="txtusername" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-10">
                        ...
                        <div class="controls">
                            <div class="input-with-icon  right">
                                <i class=""></i>
                                <input type="password" name="<%=Constants.LOGIN_PASSWORD_FIELD%>" id="txtpassword" class="form-control">
                            </div>
                        </div>
                    </div>
                </div>
